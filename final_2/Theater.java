...
public class Theater {
	...
	public Ticket printTicket(String boxOfficeId, Seat seat, int client) {
		...
		if (used) {
			...
			tickets = Collections.synchronizedList( new ArrayList<Ticket>());
			tickets.add(t);
	...
	public static void main(String[] args) {
		...
		tr.printTicket("BX1", tr.bestAvailableSeat(), 3);
		tr.printTicket("BX1", tr.bestAvailableSeat(), 5);
		tr.printTicket("BX1", tr.bestAvailableSeat(), 7);
		tr.printTicket("BX1", tr.bestAvailableSeat(), 9);
		tr.printTicket("BX1", tr.bestAvailableSeat(), 11);
		tr.printTicket("BX1", tr.bestAvailableSeat(), 12);
		tr.printTicket("BX1", tr.bestAvailableSeat(), 13);
		List<Ticket> log = tr.getTransactionLog();
		for(Ticket t: log){
